        ...
        <>
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-1 flex items-stretch justify-start pl-4">
                <div className="flex-shrink-0 flex items-center">
                  <img
                    className="block h-8 w-auto"
                    src="https://www.aleia.io/wp-content/uploads/2020/07/Logo-Aleia-N.png"
                  />
                 
                </div>
                <div className="hidden sm:block sm:ml-24 mt-5">
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? ' text-gray-800' : 'text-md text-gray-800 hover:bg-gray-700 hover:text-white',
